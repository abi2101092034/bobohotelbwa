...
@section('content')
    <section id="content"
        ...
        <form action="{{ route('register') }}" method="POST" class="flex flex-col justify-between flex-1 px-[18px] pt-8 pb-6"
            ...
            <p class="font-medium text-sm leading-[21px] text-[#757C98] text-center mt-3">Already have an account? <a
                    href="signin.html" class="font-semibold text-[#4041DA]">Sign In</a></p>
        </form>
    </section>
